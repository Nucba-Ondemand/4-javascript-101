...
import { addProduct } from "../cart/cart.js"; //Agregar luego de pasar todo al archivo de carrito
...
//función para inicializar la sección de productos
export const productsSectionInit = () => {
  renderProducts(appState.products[0]);
  showMoreBtn.addEventListener("click", showMoreProducts);
  categoriesContainer.addEventListener("click", applyFilter);
  productsContainer.addEventListener("click", addProduct); //Agregar luego de pasar todo al archivo de carrito
};
